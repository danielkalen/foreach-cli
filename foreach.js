...
(function() {
  var args, chalk, commandToExecute, console, exec, executeCommandFor, finalLogs, forceColor, fs, getDirName, glob, globToRun, help, options, outputFinalLogs, path, processPath, regEx, statusBar, yargs;
